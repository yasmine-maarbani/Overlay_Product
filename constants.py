...
placement_select_options = (
    'on', 'standing on', 'buried in', 'emerging from', 'in', 'custom', 'None')
placement_options = [
    ' marble platform', 'beige platform', 'reflective platform',
    'glass platform', 'marble surface','reflective surface', 'rippling water', 'concrete surface',
    'white surface', 'wooden surface', 'wet surface', 'wooden cutting board', 'plate', 'kitchen counter',
    'bathroom counter', 'a tree stump', 'a dried wood', 'a marble block', 'flat stones', 'rocks', 'white rock',
    'mossy rock', 'a mossy ledge', 'mound of moss', 'flower patch', 'ice', 'a natural hill', 'grass', 'a mound of '
